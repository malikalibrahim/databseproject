...
$userData = $database->getCustomerByID($klantID);
...
<div class="form-container">
        ...
        <form action="gegevensbewerken.php" method="post">
  ...
  <h2>Edit User Information</h2>
            ...
            <input type="text" id="name" name="Naam" value="<?php echo $userData['Naam']; ?>" required><br>
</div>
<div>
            <label for="address">Address:</label>
            <input type="text" id="address" name="Adres" value="<?php echo $userData['Adres']; ?>" required><br>
</div>
<div>
            <label for="licenseNumber">License Number:</label>
            <input type="text" id="licenseNumber" name="Rijbewijsnummer" value="<?php echo $userData['Rijbewijsnummer']; ?>" required><br>
            </div>
            <div>
            <label for="phoneNumber">Phone Number:</label>
            <input type="text" id="phoneNumber" name="Telefoonnummer" value="<?php echo $userData['Telefoonnummer']; ?>" required><br>
            </div>
            <div>
            <label for="email">Email:</label>
            <input type="email" id="email" name="Emailadres" value="<?php echo $userData['Emailadres']; ?>" required><br>
            </div>
            <div>
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Extract user information with isset checks
    $name = isset($_POST['Naam']) ? $_POST['Naam'] : '';
    $address = isset($_POST['Adres']) ? $_POST['Adres'] : '';
    $licenseNumber = isset($_POST['Rijbewijsnummer']) ? $_POST['Rijbewijsnummer'] : '';
    $phoneNumber = isset($_POST['Telefoonnummer']) ? $_POST['Telefoonnummer'] : '';
    $email = isset($_POST['Emailadres']) ? $_POST['Emailadres'] : '';
    $password = isset($_POST['password']) ? $_POST['password'] : '';

    // Ensure none of the user input is null before calling editUser
    if ($name !== '' && $address !== '' && $licenseNumber !== '' && $phoneNumber !== '' && $email !== '' && $password !== '') {
        $db = $database->editUserr($klantID, $name, $address, $licenseNumber, $phoneNumber, $email, $password);
